 ...
 * |  `   |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |  `   |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | F13  |  TAB |   Q  |   W  |   E  |   R  |                    |   J  |   L  |   U  |   Y  |   ;  | Bspc |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | F14  |LShift|   A  |   S  |   D  |   F  |-------.    ,-------|   H  |   N  |   E  |   I  |   O  |  '   |
 * |------+------+------+------+------+------|  MUTE |    |  F24  |------+------+------+------+------+------|
 * | F15  | LCTR |   Z  |   X  |   C  |   M  |-------|    |-------|   K  |   M  |   ,  |   .  |   /  |RShift|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LAlt |   V  |LOWER | /Space  /       \Enter \  |RAISE | RCTR | RAlt | RGUI |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
 ...
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Esc  | Ins  | Pscr | Menu |      | Scrn |                    | PUp  | PWrd |  Up  | NWrd |      |  Del |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  |      |      |      |      | Caps |-------.    ,-------| PDwn | Left | Down | Rigth|      |      |
 * |------+------+------+------+------+------|  MUTE |    |  F24  |------+------+------+------+------+------|
...
[_RAISE] = LAYOUT(
  ...
  _______, KC_INS,  KC_PSCR,  KC_APP,   KC_NO,   SGUI(KC_S),                           KC_PGUP, KC_PRVWD,KC_UP,   KC_NXTWD,KC_NO,   KC_DEL,
  _______, KC_NO,   KC_NO,    KC_NO,    KC_NO,   KC_CAPS,                              KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO,   KC_NO,
  _______, KC_UNDO, KC_CUT,   KC_COPY,  KC_PASTE,KC_NO,   _______,            _______, KC_NO,   KC_HOME, KC_NO,   KC_END,  KC_NO, _______,
                     _______, _______,  _______, _______, _______,            _______, _______, _______, _______, _______
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_ADJUST] = LAYOUT(
  ...
  KC_CAPS, KC_QWERTY, KC_GAME, KC_NO,   KC_NO,   KC_NO,                                 KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_NO,
  CG_TOGG, KC_NO,     KC_NO,   KC_NO,   KC_NO,   KC_NO,                                 KC_NO,   KC_VOLD, KC_MUTE, KC_VOLU, KC_NO, KC_NO,
